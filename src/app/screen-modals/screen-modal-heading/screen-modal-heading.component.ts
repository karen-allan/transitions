...
@Component({
  selector: 'app-screen-modal-heading',
  templateUrl: './screen-modal-heading.component.html',
  styleUrl: './screen-modal-heading.component.css'
})
export class ScreenModalHeadingComponent {
