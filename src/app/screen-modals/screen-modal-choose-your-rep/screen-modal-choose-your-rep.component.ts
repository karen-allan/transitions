...
@Component({
  selector: 'app-screen-modal-choose-your-rep',
  templateUrl: './screen-modal-choose-your-rep.component.html',
  styleUrl: './screen-modal-choose-your-rep.component.css'
})
export class ScreenModalChooseYourRepComponent {
  ...
  constructor(public dialogRef: MatDialogRef<ScreenModalChooseYourRepComponent>, private dataService: DataService) { }
