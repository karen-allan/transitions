...
let STWTMedicine: string[] = [
    'the Stomach is described as a muscular structure that stores and breaks down food ' +
...
let SPWTMedicine: string[] = [
    'the Spleen functions as a reservoir for red blood cells ' +
...
let HTWTMedicine: string[] = [
    'the Heart is seen as the pump that continuously ' +
...
let SIWTMedicine: string[] = [
    'the Small Intestine breaks down carbohydrates, proteins and fats so ' +
...
let BLWTMedical: string[] = [
    'the Bladder is described as muscular organ that receives urine from ' +
...
let KIWTMedical: string[] = [
    'the Kidney is responsible for regulating the content of water and other ' +
...
let TWWTMedical: string[] = [
    'Triple Warmer is a non-entity as it has no physical organ.',
]

export const TripleWarmerWesternMedicine: MedicalViews = new MedicalViews(TWWTMedical);

let GBTWMedical: string[] = [
    'the Gallbladder is responsible for storing bile produced by the Liver. ' +
...
let LRTWMedical: string[] = [
    'the Liver is responsible for removing toxins from the blood and ' +
...
let LUWTMedical: string[] = [
    'the Lungs as being organs of respiration, inhaling ' +
...
let LIWTMedical: string[] = [
    'the Large Intestine is a digestive organ that receives ' +
