...
let STCHMedicine: string[] = [
    'the Stomach as the  \"Sea of Nutrients\", also transfers ' +
...
let SPCHMedicine: string[] = [
    'the Spleen as the \"Official of Transformation and Transportation\" distributes the blood as well as the Chi (energy) ' +
...
let HTCHMedicine: string[] = [
    'the Heart as the \"Supreme Monarch\" maintains internal peace and harmony in the body.',
]
...
let SICHMedicine: string[] = [
    'the Small Intestine as the \"The Separator of the Pure from the Impure\". ' +
...
let BLCHMedical: string[] = [
    'the Bladder as the \"Official in Charge of Eliminating Fluid Waste\" ' +
...
let KICHMedical: string[] = [
    'the Kidneys as the \"Storehouse of the Vital Essence\" are responsible for creating and ' +
...
let PCCHMedical: string[] = [
    'the Pericardium as the \"Court Jester\" who\'s function it is to ' +
...
let TWCHMedical: string[] = [
    'the Triple Warmer or Triple Heater is a very integral meridian. ' +
...
let GBCHMedical: string[] = [
    'the Gallbladder is a wise Judge making careful decisions that ' +
...
let LRCHMedical: string[] = [
    'the Liver as the \"Commander of the Blood\" ' +
...
let LUCHMedical: string[] = [
    'the Lungs as the \"Official of Rhythmic Order\" rules ' +
...
let LICHMedical: string[] = [
    'the Large Intestine ' +
    'as the \"The Dust Bin Collector\". It must discriminate between substances the body can ' +
