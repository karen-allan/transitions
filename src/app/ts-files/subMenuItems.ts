...
export const SUB_MENU_ITEMS: SubMenuItem[] = [
    ...
    {id: 32, parent_id: 3, title: 'DECREASE PAIN', url: 'decreasePain'},
    {id: 33, parent_id: 3, title: 'DO ENERGY EXERCISES', url: 'doEnergyExercises'},
    {id: 34, parent_id: 3, title: 'DISCOVER YOUR ELEMENT', url: 'discoverElement'},
    {id: 35, parent_id: 3, title: 'TRACE YOUR MERIDIANS', url: 'traceMeridians'},

    {id: 40, parent_id: 4, title: 'CARE FOR PATIENTS', url: 'careForPatient'},
    {id: 41, parent_id: 4, title: 'SUPPORT FOR CAREGIVERS', url: 'supportCaregivers'},
    {id: 42, parent_id: 4, title: 'CREATE A LEGACY', url: 'createLegacy'},
    {id: 43, parent_id: 4, title: 'CHOOSE A MEMORIAL', url: 'chooseMemorial'},
    ...
    {id: 62, parent_id: 6, title: 'NAME YOUR ADVOCATE', url: 'advocateDoc'},
